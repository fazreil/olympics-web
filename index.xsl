...
<table width="100%">
    <td bgcolor="black"/>
    <td bgcolor="black">
        <video src="http://10.3.10.137:8080/jenkins/job/Olympics2016/ws/OpenetGO-Rally.ogv" controls="" autoplay="" loop="" height="600" width="100%"></video>
    </td>
    <td bgcolor="black"/>
</table>
<!-- End Homepage Slider -->
...
<header>
    <div class="sticky-nav">
        <a id="goUp">OpenetGO <xsl:value-of select="year"/></a>
...
<div id="work" class="page">
    ...
    <table width="100%" border="1">
        <th>Games</th><th>Date Start</th><th>Date End</th><th>PIC</th><th>Venue</th><th>Participants</th>
        <xsl:for-each select="games/game">
        <tr>
          <td><xsl:value-of select="name"/></td>
          <td><xsl:value-of select="date/start"/></td>
          <td><xsl:value-of select="date/end"/></td>
          <td><xsl:value-of select="personInCharge"/></td>
          <td><xsl:value-of select="venue"/></td>
          <td>
            <xsl:for-each select="participants/participant">
                <xsl:value-of select="name"></xsl:value-of> (<xsl:value-of select="mode"/>)<br/>
            </xsl:for-each>
          </td>
        </tr>
        </xsl:for-each>
...
<div id="about" class="page-alternate">
    <div class="container">
        ...
        <div class="row">
            ...
            <xsl:for-each select="teams/team/teamMembers/teamMember">
            <!-- Start Profile -->
            <div class="span4 profile">
               <div class="image-wrap">
                ...
                <img>
                 <xsl:attribute name="src">team/<xsl:value-of select="picture"/></xsl:attribute>
                 <xsl:attribute name="width">240</xsl:attribute>
                 <xsl:attribute name="height">240</xsl:attribute>
                </img>
            </div>
            <h3 class="profile-name"><xsl:value-of select="name"/></h3>
            <p class="profile-description"><xsl:value-of select="email"/></p>
...
<footer>
<!--
	<p class="credits">2013 Brushed. <a href="http://themes.alessioatzeni.com/html/brushed/" title="Brushed | Responsive One Page Template">Brushed Template</a> by <a href="http://www.alessioatzeni.com/" title="Alessio Atzeni | Web Designer &amp; Front-end Developer">Alessio Atzeni</a></p>
-->
</footer>
<!-- End Footer -->
